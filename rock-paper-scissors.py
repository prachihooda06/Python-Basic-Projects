...
while True:
    ...
    print("\nComputer's turn")
    print("----------------------")
    print("Computer has done his move secretly.")
    ...
    if computer_choice_name == user_choice_name:
        print("\nDraw")
    elif ((computer_choice_name == 1 and user_choice_name == 2) or (computer_choice_name == 2 and user_choice_name == 3)
          or (computer_choice_name == 3 and user_choice_name == 1)):
